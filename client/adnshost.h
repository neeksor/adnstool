...
extern int ov_concurrent_limit;
...
extern optfunc of_asynch_id, of_cancel_id, of_limit;
...
struct pending_node {
  struct pending_node *next, *back;
  char *owner;
};

extern adns_state ads;
extern struct pending_list { struct pending_node *head, *tail; } outstanding;
extern struct processing_list { struct query_node *head, *tail; int size; } processing;
